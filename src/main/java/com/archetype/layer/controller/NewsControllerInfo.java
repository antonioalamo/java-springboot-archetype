...
public interface NewsControllerInfo {
    ...
    NewsResponseDTO create(@Valid @RequestBody NewsRequestDTO request);
    ...
    @GetMapping("/{id}")
    NewsResponseDTO getById(@Parameter(description = "ID of the news article") @PathVariable String id);
    ...
    @PutMapping("/{id}")
    NewsResponseDTO update(@Parameter(description = "ID of the news article") @PathVariable String id,
