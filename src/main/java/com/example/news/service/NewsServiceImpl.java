...
import com.example.news.mapper.persistence.NewsPersistenceMapper;
import com.example.news.persistence.NewsRepository;
import com.example.news.persistence.document.NewsDocument;
import com.example.news.event.HighImportanceNewsCreatedEvent;
import com.example.news.service.exception.NewsCreationException;
import com.example.news.service.exception.NewsValidationException;
